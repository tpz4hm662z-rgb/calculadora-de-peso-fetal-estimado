...
El flujo de trabajo base es:

1. Duplicar la plantilla.
2. Cambiar la configuración.
3. Escribir el cálculo.
4. Completar el protocolo oficial de desarrollo, auditoría, publicación e integración.
...
Cada herramienta tendrá su propio sitemap individual. Este no sustituye al sitemap general del Portal Herramientas360.
...
El procedimiento detallado y sus checklists obligatorios se encuentran en `GUIA-DESARROLLO.md`.
...
Pertenece al repositorio de cada herramienta. Antes de publicar se deben actualizar siempre:
...
Pertenece al Portal Herramientas360. Al integrar una herramienta se deben actualizar siempre:
...
El sitemap del portal debe validarse como XML y no puede contener URLs duplicadas.

---

# 🏁 Cierre oficial del proyecto

Ninguna herramienta puede cerrarse hasta confirmar:
